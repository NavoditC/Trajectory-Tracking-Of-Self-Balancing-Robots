...
//long gyroXCalli = -203, gyroYCalli = 197, gyroZCalli = 364; // Obtained by callibrating gyroscope values
//long accelXCalli = 377, accelYCalli = 775, accelZCalli = 16936; // Obtained by callibrating accelerometer values
...
double kp_balance = 65, kd_balance = 0.75;
...
/*
mainfunc() is the function that is called at your specified sampling rate. The
sampling rate is 25ms. This function will be called at every sampling instance.
*/
void mainfunc()
{
  ...
  if (speed_control_period_count >= 8)
  {
    ...
    encoder_right_pulse_num_speed = encoder_left_pulse_num_speed;
  ...
  motor_voltage = 0;
  pwm_left += motor_voltage;
  pwm_right += motor_voltage;
